...
LABEL_FONT = pygame.font.SysFont("comicsans", 24, True)
...
class Target:
    ...
    def draw(self, win):
        ...
        pygame.draw.circle(win, self.SECOND_COLOR, (self.x, self.y), self.size * 0.5)
...
def end_screen(win, elapsed_time, targets_pressed, clicks):
    ...
    accuracy_label = LABEL_FONT.render(f"Accuracy: {LIVES - accuracy}%", 1, "white")
